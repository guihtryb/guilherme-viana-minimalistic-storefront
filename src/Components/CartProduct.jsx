...
class CartProduct extends Component {
  ...
  attributeStyle(item, attributeName, attributeItem) {
    const chosenStyle = item.attributesChosen
      .some((attribute) => Object.keys(attribute)[0] === attributeName &&
      Object.values(attribute)[0] === attributeItem.value);
            ...
            <div className="cart-product" key={ index }>
              <div className="cart-product-infos">
                ...
                </span>
                {
                  ...
                  item.productAttributes.map((attribute, index) => (
                    index < 1 &&
                      <div
                        ...
                        <div className="attribute-options">
                          { attribute.name === 'Color' ?
                            attribute.items.map((attrItem) => (
                              <div
                                className="cart-attribute-option-color"
                            ...
                            : attribute.items.map((attrItem) => (
                              <div
                                ...
                                className={ `cart-attribute-option
              ...
              <div className="cart-product-quantity-and-image">
                <div className="product-quantity-control-container">
                  <button
                    type='button'
                    className="product-quantity-control-btn"
